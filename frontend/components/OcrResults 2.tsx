  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        {(data ?? []).slice(0, 12).map((r: { id: string; device_type?: string; created_at: string; brand_model?: string; rated_watts: number; wh: number; confidence?: number }) => (
...
function Badge({ label, value }: { label: string; value: number | string | null }) {
  return (
