 ...
 */
export function pressable(variant: "primary" | "secondary" | "tertiary" = "primary"): string {
 ...
 */
export function card(interactive: boolean = false): string {
 ...
 */
export function safeArea(): string {
