...
async def download_vat_csv(tenant_id: str, month: str):
    ...
    return Response(
        content=csv_bytes,
        media_type="text/csv",
        headers={"Content-Disposition": f"attachment; filename=vat_report_{month}.csv"},
    )
...
async def download_vat_pdf(tenant_id: str, month: str):
    ...
    return Response(
        ...
        headers={"Content-Disposition": f"attachment; filename=vat_report_{month}.html"},
    )
...
async def download_calendar(tenant_id: str):
    ...
    return Response(
        ...
        headers={"Content-Disposition": f"attachment; filename=converto_reminders.ics"},
    )
