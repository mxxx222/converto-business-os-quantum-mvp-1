...
async def get_entitlements(tenant_id: str):
    ...
    Returns:
        Entitlements (tier, modules, limits, usage)
    """
...
async def check_feature(tenant_id: str, feature_name: str):
    ...
    Args:
        tenant_id: Tenant ID
        feature_name: Feature name (e.g., "ai_chat", "notion_sync")
...
async def increment_usage(tenant_id: str, metric: str, amount: int = 1):
    ...
    Args:
        tenant_id: Tenant ID
        metric: Usage metric (e.g., "ocr_scans_used", "ai_chat_queries_used")
...
def require_feature(feature_name: str):
    ...
    Usage:
        @router.get("/ai/chat")
        async def ai_chat(tenant_id: str = Depends(require_feature("ai_chat"))):
            ...
    """
